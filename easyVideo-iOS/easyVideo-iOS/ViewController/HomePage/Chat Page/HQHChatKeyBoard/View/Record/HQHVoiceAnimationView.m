...
@interface HQHVoiceAnimationView ()
...
@implementation HQHVoiceAnimationView
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [NSNotificationCenter.defaultCenter addObserver:self selector:@selector(changeMaskView:) name:kHQHAudioRecorderNotification object:nil];
    }
    return self;
}
...
- (void)setState:(HQHVoiceState)state {
    _state = state;
