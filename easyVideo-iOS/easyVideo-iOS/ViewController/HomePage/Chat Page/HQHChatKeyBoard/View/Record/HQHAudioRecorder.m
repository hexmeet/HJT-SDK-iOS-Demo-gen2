...
NSString *const kHQHAudioRecorderNotification = @"kHQHAudioRecorderNotification";

@interface HQHAudioRecorder ()
...
static HQHAudioRecorder *_audioRecorder;

@implementation HQHAudioRecorder
...
//        self->_currentVoiceLevel = (int)(level * 100);
        [NSNotificationCenter.defaultCenter postNotificationName:kHQHAudioRecorderNotification object:nil userInfo:@{@"voiceLevel":@((int)(level * 100))}];
    });
}
