...
@interface EVUserIdManager : NSObject
...
/**
 ...
 @param fail 失败回调
 */
- (void)insertNewEntity:(EMGroupMemberInfo *)model success:(void(^__nullable)(void))success fail:(void(^__nullable)(NSError *error))fail;
